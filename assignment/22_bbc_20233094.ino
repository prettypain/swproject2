...
#define _INTERVAL_SERVO   25 // servo interval (unit: ms)
...
#define _DUTY_MIN 537
#define _DUTY_MAX 2392
#define _DUTY_NEU 1459
...
float volt_to_distance(int x)
{
  ...
  return (693 + -2.99*x + 4.52E-3*x*x + -2.42E-6*x*x*x);
}
